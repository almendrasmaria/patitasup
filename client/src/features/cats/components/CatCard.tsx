  ...
  return (
    <article className="w-full overflow-hidden rounded-[28px] bg-white shadow-md ring-1 ring-black/5">
      ...
      <div className="flex flex-col px-6 pt-5 pb-6">
        <h3 className="text-center text-3xl font-semibold text-[#1E293B]">
          {cat.name}
        </h3>
        ...
        <p className="mt-6 mb-4 min-h-[96px] text-center text-sm leading-relaxed text-slate-500 line-clamp-4">
          {cat.description}
        </p>
