...
const HeroHome = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pt-32 pb-12 sm:pt-38 sm:pb-16 text-center">
        <h1 className="text-[48px] sm:text-[80px] leading-[1] font-semibold drop-shadow-[0_12px_32px_rgba(0,0,0,0.6)]">
          PatitasUp
        </h1>

        <p className="mt-4 max-w-2xl mx-auto text-[14px] sm:text-base md:text-lg text-white/90 font-normal">
